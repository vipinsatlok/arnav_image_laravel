...
<section class="max-w-screen-xl flex-col flex flex-wrap items-start justify-between mx-auto p-4">
    ...
    <div class="mb-8">
        ...
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            ...
            <li>
                You may submit PNG images to Da freepng, but you must ensure that you have the necessary rights to do so.
            </li>
            <li>
                You may download PNG images from Da freepng and use them in your own projects, but you must comply with the terms of use specified for each image.
            </li>
        </ul>
    </div>
    ...
    <div class="mb-8">
        ...
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            ...
            <li>
                You retain all intellectual property rights to the images you submit.
            </li>
            <li>
                By submitting images to Da freepng, you grant us a non-exclusive, worldwide, royalty-free license to use, reproduce, distribute, and display those images for the purpose of operating and promoting Da freepng.
            </li>
        </ul>
    </div>
    ...
    <div class="mb-8">
        ...
        <ul class="space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
            ...
            <li>
                You use all images from Da freepng at your own risk. We do not guarantee the accuracy, quality, or safety of any images.
            </li>
        </ul>
    </div>
