...
<nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex items-center md:order-3">
            <button id="searchToggle" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
                <span class="sr-only">Open main menu</span>
                <i class="fa-sharp text-xl text-gray-400 fa-solid fa-magnifying-glass"></i>
            </button>
    ...
    <div id="searchSection" class="max-w-screen-xl w-full {{ request('search') ? 'flex' : 'hidden' }} flex-wrap items-center justify-between mx-auto px-4 pb-4">
